                ...
                <form method="POST" action="{{route('announcements.store')}}">
                  @csrf
                    ...
                    <div class="mb-3">
                      ...
                      <input placeholder="Inserisci qui il prezzo del tuo annuncio" required autofocus name="price" type="number" min="0" value="{{old('price')}}" step=".01" class="form-control input-shadow-form rounded-pill" id="price" aria-describedby="price">
                      @error('price')
                            <div class="alert background-accent d-inline-block my-3 text-dark text-uppercase">
                                {{ $message }}</div>
                      @enderror
                    ...
                    <div class="mb-3">
                      ...
                      <textarea placeholder="Inserisci qui la descrizione del tuo annuncio" required autofocus class="form-control input-shadow-form " name="body" id="descrizione" cols="30" rows="10">{{old('body')}}</textarea>
                      @error('body')
                            <div class="alert background-accent d-inline-block my-3 text-dark text-uppercase">
                                {{ $message }}</div>
                      @enderror
