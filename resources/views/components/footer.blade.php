<footer>
    <div class="container-fluid px-0">
        <img class="img-fluid"src="/media/layout footer viola png.png" alt="layout footer">
    </div>
    <div class="container-fluid px-0 bg-gradient-footer py-5">
        <div class="container h-100 py-5">
            <div class="row h-100 align-items-end">
                <div class = "d-flex flex-wrap justify-content-center ms-0 ms-sm-5">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 text-center text-sm-start">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a class="text-white text-decoration-none line-height40" href="">Twitter</a></li>
                        </ul>
                    </div>
