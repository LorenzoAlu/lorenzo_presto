...
<div class="container">
    ...
    <div class="row justify-content-center align-items-center text-center my-5">
        ...
        <div class="col-12">  
            <img src="/media/20945436.jpg" class="img-fluid mx-auto img-desk1 img-mobile1" alt="pagina-non-trovata">
            
            </div>
            <div class="col-12">
                <p class="lead">Ritorna alla pagina principale e prova a ricercare.</p>
