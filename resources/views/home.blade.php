    ...
    <section>
        <div class="container-fluid bg-img2 bg-new2">
            ...
            <div class="row pt-lg-5 mt-lg-100 bg-white1 h-md-50">
                ...
                <div
                    class=" col-12 col-xxl-2 d-flex flex-xxl-column justify-content-evenly  align-items-center mt-5 pt-5 display-none d-md-hidden">
                    <a href=""><i
                ...
                <div
                    class="col-12  col-xxl-8 offset-xxl-1 d-flex  justify-content-center align-items-center mt-lg-1 pt-lg-5">
        ...
        <div class="row justify-content-center">
             ...
             <div class="col-12  col-md-5 col-xxl-4 d-block d-md-none text-align-mobile text-center ">
                ...
                <div class="collapse" id="collapseExample">
                    @foreach ($categories as $category)
                        <div class="col-12  col-md-5 col-xxl-4 d-md-block text-align-mobile text-center">
                            <button class="btn  btn3 btn3-1 shadow  my-3">
                                <a class="text-decoration-none text-main-color p-3 text-center"
                                    href="{{ route('categories.index', $category) }}">{{ $category->name }}</a>
                            </button>
